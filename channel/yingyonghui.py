...
class Channel(public.Methods):
    def login(self, driver):
        u'''渠道login'''
        if self.images_or_none(driver, 'yingyonghui_change_login.1920x1080.png',way_name='channel'):
            self.click_images(driver,"yingyonghui_change_login.1920x1080.png",way_name='channel')
