...
class Methods():
    ...
    def game_click02(self,driver,name,way_name='channel',direction=None):
        ...
        for i in name:
            for x in xrange(10):
                ...
                image = self.images_or_none(driver,i+'.1920x1080.png')
                if image:
                    sleep(2)
    ...
    def guide_exist(self,driver,name):
        ...
        for x in xrange(10):
            ...
            image = self.images_or_none(driver, name[0] + '.1920x1080.png')
            if image:
    ...
    def game_click2(self,driver,name):
        ...
        for i in name:
            log.info('寻找: %s' % (i))
            image = self.images_or_none(driver, i + '.1920x1080.png',timeout=2)
            if image:
                driver.click(image[0][0], image[0][1])
                log.info('点击图片 %s 成功     图片信息 %s' % (i, image))
    ...
    def pay_in(self,driver,name,way_name='channel',direction=None):
        ...
        for i in name:
            for x in xrange(5):
                log.info('第 %s 次寻找: %s' % (x + 1, i))
                image = self.images_or_none(driver, i + '.1920x1080.png', way_name)
                if image:
                    driver.click(image[0][0], image[0][1])
                    log.info('点击图片 %s 成功     图片信息 %s' % (i, image))
                    break
    ...
    def pay_up(self,driver,way_name):
        ...
        for i in xrange(5):
            ...
            image = self.images_or_none(driver, name[0] + '.1920x1080.png', way_name)
            if image:
                driver.click(image[0][0], image[0][1])
