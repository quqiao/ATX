...
class Game(public.Methods):
    ...
    def guide(self,driver):
        if self.images_or_none(driver,'guide_exist_01.1920x1080.png'):
            '''创建战舰'''
            ...
            for i in range(20):
                ...
                sleep(1)
                if self.exist(driver,"guide_exist_01.1920x1080.png"):
                    break
            sleep(1)
            for i in range(3):
                driver.click(500,500)
            ...
            for i in range(1000):
                ...
                if self.exist(driver,"guide_exist_02.1920x1080.png"):#等待战斗胜利
                    break        
            self.click_images(driver,"guide_exist_02.1920x1080.png")
            '''武器强化'''
            sleep(2)
            for i in range(2):
                driver.click(500,500)
            ...
            print "引导已完成"  
        if self.wait_gone_images(driver,'guide_022.1920x1080.png'):
            log.info('引导成功')
            return 'ok'
        else:
            log.info('引导失败')
    ...
    def game_pay_pre(self,driver):
        self.click_images(driver,"game_pay_01.1920x1080.png")
        if self.wait_gone_images(driver,'game_pay_01.1920x1080.png'):
            log.info('进入游戏前准备成功')
            return 'ok'
        else:
            log.info('进入游戏前准备失败')
    ...
    def game_pay1(self,driver):
        self.click_images(driver,"game_pay_02.1920x1080.png")
        if self.wait_gone_images(driver,'game_pay_02.1920x1080.png'):
            log.info('进入游戏前准备成功')
            return 'ok'
        else:
            log.info('进入游戏前准备失败')
    ...
    def basicFunction(self,driver):
        self.click_images(driver,"BasicFunction_01.1920x1080.png")
        self.click_images(driver,"BasicFunction_02.1920x1080.png")
        self.click_images(driver,"BasicFunction_03.1920x1080.png")
        self.click_images(driver,"BasicFunction_04.1920x1080.png")
        self.click_images(driver,"BasicFunction_03.1920x1080.png")
        self.click_images(driver,"BasicFunction_05.1920x1080.png")
        self.click_images(driver,"BasicFunction_06.1920x1080.png")
        self.click_images(driver,"BasicFunction_07.1920x1080.png")
        self.click_images(driver,"BasicFunction_06.1920x1080.png")
        self.click_images(driver,"BasicFunction_08.1920x1080.png")
        self.click_images(driver,"BasicFunction_03.1920x1080.png")
        self.click_images(driver,"BasicFunction_09.1920x1080.png")
        self.click_images(driver,"BasicFunction_03.1920x1080.png")
        self.click_images(driver,"BasicFunction_10.1920x1080.png")
        self.click_images(driver,"BasicFunction_03.1920x1080.png")
        self.click_images(driver,"BasicFunction_11.1920x1080.png")
        self.click_images(driver,"BasicFunction_03.1920x1080.png")
        self.click_images(driver,"BasicFunction_12.1920x1080.png")
        self.click_images(driver,"BasicFunction_06.1920x1080.png")
        self.click_images(driver,"BasicFunction_13.1920x1080.png")
        self.click_images(driver,"BasicFunction_06.1920x1080.png")
        self.click_images(driver,"BasicFunction_14.1920x1080.png")
        self.click_images(driver,"BasicFunction_03.1920x1080.png")
        self.click_images(driver,"BasicFunction_15.1920x1080.png")
        self.click_images(driver,"BasicFunction_03.1920x1080.png")
        self.click_images(driver,"BasicFunction_16.1920x1080.png")
        self.click_images(driver,"BasicFunction_03.1920x1080.png")
        self.click_images(driver,"BasicFunction_17.1920x1080.png")
        self.click_images(driver,"BasicFunction_03.1920x1080.png")
        self.click_images(driver,"BasicFunction_18.1920x1080.png")
        self.click_images(driver,"BasicFunction_03.1920x1080.png")
        self.click_images(driver,"BasicFunction_19.1920x1080.png")
        self.click_images(driver,"BasicFunction_03.1920x1080.png")
        if self.wait_gone_images(driver, 'BasicFunction_03.1920x1080.png'):
            return 'ok'
        else:
            return None
